...
path = '/mnt/projects/USS_MEP/COIL_ORIENTATION/sub-X02299_ses-1_task-coilorientation_emg.mat'
data = read_mat(path)
...
def getdata(path, key):
  ...
  for i in range(len(X)):
    X_sliced.append(X[i,:][10040:10200])
  return X,y,np.transpose(X_sliced)
