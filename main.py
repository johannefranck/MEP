...
k
"""X_amplitude, X_latency,X_ampl_late, X_norm, X_diff = data.other_X(X)
...
#plot_functions.plot_subject_coil(X,y,groups,list_subjects = list_subjects,mean=False,subject=subject)
