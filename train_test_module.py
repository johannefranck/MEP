...
if __name__ == "__main__":
    ...
    avg_validation_result, validation_results, precision_results, recall_results, f1_results = cv_logo(my_model, data = X, labels = y, groups = groups, num_epochs=1, batch_size=16)
    ...
    #tot_scores, tot_indi_scores, mean_indi_scores = kfold_prsubject_stratified(X, y, groups, my_model, num_epochs=1, batch_size=16)
    print("hej")
